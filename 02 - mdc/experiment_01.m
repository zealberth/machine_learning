% Cauculate accuracy using Minimum Distance to Centroid
...
%% experiment setup
n_repetition = 30;
dataset_names = {'bcw'};      % conjuntos de dados 'column2C', 'bcw' , 'iris', 'column3C', 'dermatology' 
