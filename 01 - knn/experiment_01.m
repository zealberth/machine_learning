...
%% experiment setup
n_repetition = 30;
dataset_names = {'iris', 'column3C'};      
% conjuntos de dados 'column2C', 'iris', 'column3C', 'dermatology', 'bcw'
% better K for each dataset 'column2c=19', 'iris=15', 'column3C=15', 'dermatology = 3', 'bcw = 5'
