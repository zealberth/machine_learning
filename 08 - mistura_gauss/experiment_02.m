...
dataset_names = {'iris'}; % conjuntos de dados % conjuntos de dados 'column2C', 'bcw' , 'iris', 'column3C', 'dermatology' 
...
for i=1:length(dataset_names)
    ...
    for j=1:n_repetition
        ...
        for k=1:size(combinations,1)
            ...
            %% train
            q = 1;
            [mi, sigma, alfa, p_w] = mix_gauss_train(x_train, data.y_train, q);     
            ...
            y_hat = mix_gauss_predict(xy, mi, sigma, alfa, q, p_w);
